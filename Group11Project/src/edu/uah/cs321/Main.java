...
//			u = AuthSystem.addUser("master1", "account","master","password");
//			u.setAboutMe("master account");
//		}
//		else {
//			u = new User("master2","account","master account","master");
//		}
...
//
//
//		final List<Movie> movies = JsonReader.getMasterMovieList();
//
